...
public class SettingsFragment extends PreferenceFragment implements
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		context=getActivity().getApplicationContext();
		 ...
		 //init setting findPreference by String 
	     updateLockSummary();
	     //init Listener pinPerference    日记上锁监听
	     pinPreference.setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
...
//	                    startActivityForResult(pinIntent, Constants.SET_PIN_REQUEST_CODE);
	     ...
	     // Workaround for About-Screen  点击关于，接口回调进入关于界面
