...
public interface IMediaService extends android.os.IInterface {
	...
	public static abstract class Stub extends android.os.Binder implements
			IMediaService {
		private static final java.lang.String DESCRIPTOR = "IMediaService";
		...
		/**
		 * Cast an IBinder object into an IMediaService interface, generating a
		 * proxy if needed.
		 */
		public static IMediaService asInterface(android.os.IBinder obj) {
			if ((obj == null)) {
				return null;
			}
			android.os.IInterface iin = obj.queryLocalInterface(DESCRIPTOR);
			if (((iin != null) && (iin instanceof IMediaService))) {
				return ((IMediaService) iin);
			}
			return new IMediaService.Stub.Proxy(obj);
		}
		...
		public boolean onTransact(int code, android.os.Parcel data,
			...
			case TRANSACTION_refreshMusicList: {
				data.enforceInterface(DESCRIPTOR);
				java.util.List<MusicInfo> _arg0;
				_arg0 = data.createTypedArrayList(MusicInfo.CREATOR);
			...
			case TRANSACTION_getMusicList: {
				data.enforceInterface(DESCRIPTOR);
				java.util.List<MusicInfo> _arg0;
				_arg0 = new java.util.ArrayList<MusicInfo>();
			...
			case TRANSACTION_updateNotification: {
				...
				if ((0 != data.readInt())) {
					_arg0 = android.graphics.Bitmap.CREATOR
			...
			case TRANSACTION_getCurMusic: {
				data.enforceInterface(DESCRIPTOR);
				MusicInfo _result = this.getCurMusic();
				reply.writeNoException();
				if ((_result != null)) {
					reply.writeInt(1);
		...
		private static class Proxy implements IMediaService {
			...
			public boolean playById(int id) throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(id);
					mRemote.transact(Stub.TRANSACTION_playById, _data, _reply,
							0);
					_reply.readException();
					_result = (0 != _reply.readInt());
				} finally {
			...
			public int duration() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_duration, _data, _reply,
							0);
					_reply.readException();
			...
			public int position() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_position, _data, _reply,
							0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			@Override
			public void refreshMusicList(java.util.List<MusicInfo> musicList)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				try {
					...
					mRemote.transact(Stub.TRANSACTION_refreshMusicList, _data,
							_reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			@Override
			public void getMusicList(java.util.List<MusicInfo> musicList)
					throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getMusicList, _data,
							_reply, 0);
					_reply.readException();
					_reply.readTypedList(musicList, MusicInfo.CREATOR);
				} finally {
					_reply.recycle();
					_data.recycle();
				}
			...
			public int getPlayState() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getPlayState, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public int getPlayMode() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getPlayMode, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			public void setPlayMode(int mode) throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					_data.writeInt(mode);
					mRemote.transact(Stub.TRANSACTION_setPlayMode, _data,
							_reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public void sendPlayStateBrocast()
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_sendPlayStateBrocast,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public int getCurMusicId() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getCurMusicId, _data,
							_reply, 0);
					_reply.readException();
					_result = _reply.readInt();
				} finally {
			...
			@Override
			public void updateNotification(android.graphics.Bitmap bitmap,
				...
				try {
					...
					mRemote.transact(Stub.TRANSACTION_updateNotification,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			public void cancelNotification() throws android.os.RemoteException {
				...
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_cancelNotification,
							_data, _reply, 0);
					_reply.readException();
				} finally {
					_reply.recycle();
			...
			@Override
			public MusicInfo getCurMusic() throws android.os.RemoteException {
				android.os.Parcel _data = android.os.Parcel.obtain();
				android.os.Parcel _reply = android.os.Parcel.obtain();
				MusicInfo _result;
				try {
					_data.writeInterfaceToken(DESCRIPTOR);
					mRemote.transact(Stub.TRANSACTION_getCurMusic, _data,
							_reply, 0);
					_reply.readException();
					if ((0 != _reply.readInt())) {
						_result = MusicInfo.CREATOR.createFromParcel(_reply);
					} else {
						_result = null;
					}
				} finally {
